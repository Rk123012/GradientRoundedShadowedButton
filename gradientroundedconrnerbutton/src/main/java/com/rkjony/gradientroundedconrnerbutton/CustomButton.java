package com.rkjony.gradientroundedconrnerbutton;
...
public final class CustomButton extends FrameLayout {
    ...
    public CustomButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            buttonText = (typedArray.getString(R.styleable.CustomButton_button_text));
            buttonTextSize = (typedArray.getDimension(R.styleable.CustomButton_button_text_size, 14));
            buttonTextColor = (typedArray.getColor(R.styleable.CustomButton_button_text_color, Color.parseColor("#9F79EE")));
            buttonStartColor = (typedArray.getColor(R.styleable.CustomButton_button_start_color, Color.parseColor("#EEA9B8")));
            buttonEndColor = (typedArray.getColor(R.styleable.CustomButton_button_end_color, Color.parseColor("#EE799F")));
            buttonPressStartColor = (typedArray.getColor(R.styleable.CustomButton_button_press_start_color, Color.parseColor("#EEA9B8")));
            buttonPressEndColor = (typedArray.getColor(R.styleable.CustomButton_button_press_end_color, Color.parseColor("#EE799F")));
            buttonGradientOrientation = (typedArray.getInt(R.styleable.CustomButton_button_gradient_orientation, 6));
            buttonRadius = ((int) typedArray.getDimension(R.styleable.CustomButton_button_radius, 10));
            buttonTextPadding = ((int) typedArray.getDimension(R.styleable.CustomButton_button_text_padding,8));



            this.setIsShadowed(typedArray.getBoolean(R.styleable.CustomButton_button_is_shadowed, true));
            this.setShadowRadius(typedArray.getDimension(R.styleable.CustomButton_button_shadow_radius, 0.0F));
            this.setShadowDistance(typedArray.getDimension(R.styleable.CustomButton_button_shadow_distance, 0.0F));
            this.setShadowAngle((float) typedArray.getInteger(R.styleable.CustomButton_button_shadow_angle, 45));
            this.setShadowColor(typedArray.getColor(R.styleable.CustomButton_button_shadow_color, Color.parseColor("#EEA9B8")));
        } finally {
            typedArray.recycle();
        }
        addButtonText();
    ...
    private void addButtonText() {
        ...
        button.setPadding(buttonTextPadding,buttonTextPadding,buttonTextPadding,buttonTextPadding);
        addView(button);
    }
    ...
    public void setButtonTextPadding(int buttonTextPadding) {
